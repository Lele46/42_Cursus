...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/01/31 14:28:29 by espinell          #+#    #+#             */
/*   Updated: 2024/02/03 10:34:09 by espinell         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	game->textures[3] = mlx_xpm_file_to_image(game->mlx, "./textures/key1.xpm",
			&size, &size);
...
int	main(int argc, char **argv)
{
	...
	game->win = mlx_new_window(game->mlx, ft_strlenh(game->map[0]) * SIZE,
			get_height(argv[1]) * SIZE, "A Dungeon Day");
	init_images(game);
	load_images(game);
